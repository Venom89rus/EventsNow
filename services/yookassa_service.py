...
async def create_payment(
    *,
    ...
    Note: Use Idempotence-Key to avoid duplicates on retries. [web:703]
    """
    ...
    headers = {
        "Authorization": _basic_auth_header(cfg.shop_id, cfg.secret_key),
...
def parse_webhook(payload: dict[str, Any]) -> tuple[str, dict[str, Any]]:
    """
